...
<nav class="navbar navbar-expand-lg navbar-light  " style="background-color:#ccc;" >
  <img src="{{asset('/image/clipart3013511.png')}}" width="100px" alt="Image">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item mx-1">
        <a class="nav-link" href="{{route('admin.customer')}}">Booked Customer</a>
      </li>
      <li class="nav-item mx-1">
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item mx-1">
        <a class="nav-link" href="{{route('booking.status')}}">Previous Booking & Status</a>
      </li>
      <li class="nav-item mx-1">
        <a class="nav-link" href="#about">About</a>
      </li>
    ...
    @endif
    <ul class="navbar-nav">   {{-- auth settings--}}
      <li class="nav-item dropdown">
       ...
       <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
         ...
         <a class="dropdown-item" href="{{url('/logout')}}">Logout</a>     {{-- logout --}}
        </div>
      </li>
    </ul>
  </div>
