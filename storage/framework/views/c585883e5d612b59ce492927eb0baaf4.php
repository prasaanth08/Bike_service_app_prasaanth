...
<body>
    ...
    <?php endif; ?>
                ...
                <div class="card-body bg-light ">
                    <form id="userForm" action="<?php echo e(route('service.store')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group mb-3 has-validation">
                            ...
                            <input type="text" name="topic"  class="form-control  <?php echo e($errors->has('topic')?'is-invalid':''); ?>">
                        ...
                        <div class="form-group mb-3 has-validation">
                            <label data-error="wrong" data-success="right" for="form8">
                                discription</label>
                                <input type="text" name="descript"  class="form-control  <?php echo e($errors->has('descript')?'is-invalid':''); ?>">
...
</html><?php /**PATH C:\Users\Nathan\Desktop\Bike Service Application\Bike_Service-app\resources\views/admin/Create_service.blade.php ENDPATH**/ ?>